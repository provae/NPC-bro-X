...
# --- Posting-gedrag ---
PHOTO_POST_CHANCE = _get_float("PHOTO_POST_CHANCE", 0.3)  # 30% kans op foto-post
MIN_INTERVAL_MINUTES = _get_int("MIN_INTERVAL_MINUTES", 60)
MAX_INTERVAL_MINUTES = _get_int("MAX_INTERVAL_MINUTES", 180)
